...
Design: Call `delegate_golden "tests/t03_run_static_security_tests.sh" "$@"` so the shim execs `${RUNNER_HOME}/tests/t03_run_static_security_tests.sh` with arguments passed through unchanged.
Tests:
