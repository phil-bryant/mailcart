...
Design: Call `delegate_golden "tests/t09_run_dynamic_security_tests.sh" "$@"` so the shim execs `${RUNNER_HOME}/tests/t09_run_dynamic_security_tests.sh` with arguments passed through unchanged.
Tests:
