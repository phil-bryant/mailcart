#!/usr/bin/env bash
# Self-contained mailcart lane for deterministic Graph bridge replay tests.
...
#R010: Run the Makefile deterministic Graph bridge replay target from the repo root.
exec make _graph-replay-test
