...
src() {
  #R001: Test harness setup for 07_clean_generated_files contract checks.
  printf '%s' "${BATS_TEST_DIRNAME}/../../07_clean_generated_files.sh"
}
...
@test "delegates to the mapped runner golden" {
  #R015-T01: Verify the pointer calls delegate_golden with 96_clean_generated_files.sh and "$@".
