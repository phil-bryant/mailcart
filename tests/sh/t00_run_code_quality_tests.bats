...
# Thin-pointer contract checks for the mailcart t00 code-quality lane wrapper.
...
setup() {
  #R001: Test harness setup for t00_run_code_quality_tests contract checks.
  REPO_ROOT="$(mailcart_repo_root)"
  SRC="${REPO_ROOT}/tests/t00_run_code_quality_tests.sh"
}
...
@test "delegates to the mapped runner golden" {
  #R015-T01: Verify the pointer calls delegate_golden for the code-quality golden with "$@".
