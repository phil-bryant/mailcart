...
# Thin-pointer contract checks for the mailcart t02 dependency-freshness lane wrapper.
...
setup() {
  #R001: Test harness setup for t02_run_dependency_freshness_tests contract checks.
  REPO_ROOT="$(mailcart_repo_root)"
  SRC="${REPO_ROOT}/tests/t02_run_dependency_freshness_tests.sh"
}
...
@test "delegates to the mapped runner golden" {
  #R015-T01: Verify the pointer calls delegate_golden for the dependency-freshness golden with "$@".
