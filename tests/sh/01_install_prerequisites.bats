...
src() {
  #R001: Test harness setup for 01_install_prerequisites contract checks.
  printf '%s' "${BATS_TEST_DIRNAME}/../../01_install_prerequisites.sh"
}
...
@test "delegates to the mapped runner golden" {
  #R015-T01: Verify the pointer calls delegate_golden with 01_install_prerequisites.sh and "$@".
