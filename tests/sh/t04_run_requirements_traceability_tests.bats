...
# Thin-pointer contract checks for the mailcart t04 traceability lane wrapper.
...
setup() {
  #R001: Test harness setup for t04_run_requirements_traceability_tests contract checks.
  REPO_ROOT="$(mailcart_repo_root)"
  SRC="${REPO_ROOT}/tests/t04_run_requirements_traceability_tests.sh"
}
...
@test "delegates to the mapped runner golden" {
  #R015-T01: Verify the pointer calls delegate_golden for the traceability golden with "$@".
