...
# Thin-pointer contract checks for the mailcart t06 python-unit lane wrapper.
...
setup() {
  #R001: Test harness setup for t06_run_python_unit_tests contract checks.
  REPO_ROOT="$(mailcart_repo_root)"
  SRC="${REPO_ROOT}/tests/t06_run_python_unit_tests.sh"
}
...
@test "delegates to the mapped runner golden" {
  #R015-T01: Verify the pointer calls delegate_golden for the python-unit golden with "$@".
