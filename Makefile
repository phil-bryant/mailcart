...
run-api:
	...
	MAILCART_MATCHY_TLS_DIR="$(MAILCART_MATCHY_TLS_DIR)" MAILCART_MATCHY_TLS_CERT_FILE="$(MAILCART_MATCHY_TLS_CERT_FILE)" MAILCART_MATCHY_TLS_KEY_FILE="$(MAILCART_MATCHY_TLS_KEY_FILE)" bash "$(MAILCART_REPO_ROOT)/04_install_matchy_api_tls.sh"; \
